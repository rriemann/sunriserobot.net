---
blog: "Flipping Tables"
---
show_data       = YAML.load_file("source/data/shows.yml").find { |s| s["prefix"] == "flippingtables" }
...
album_art_url  = "https://flippingtables.ghost.io/content/images/2014/Jul/FT_NewSquareArt.jpg"
...
xml.rss "xmlns:dc"      => "http://purl.org/dc/elements/1.1/",
        ...
        "version"       => "2.0" do
  xml.channel do
    site_url = "http://flippingtablespodcast.com"
    ...
    xml.tag! "itunes:owner" do
      xml.tag! "itunes:name", host_names
      xml.tag! "itunes:email", "pseudomichael@gmail.com"
    end
